...
ω = den_fsm.T[1:end-1, end]

# ╔═╡ 510098ba-5632-4b16-84a6-ac805ff2354a
findnz(den_fsm.T[1:end-1, 1:end-1])
...
MarkovModels = "c2ae6250-d0a1-11ea-0991-234599ce5244"
...
[[MarkovModels]]
deps = ["CUDA", "LinearAlgebra", "SparseArrays"]
git-tree-sha1 = "4f01fbb60caea1c9f83770dda7d4d8cc7d63db65"
